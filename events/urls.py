...
from events.views import EventCreate, EventUpdate, EventDelete, DayDetails, CalendarView, EventPreview
...
urlpatterns = [
    ...
    path('preview/<int:pk>/', login_required(EventPreview.as_view()), name='event-preview'),
